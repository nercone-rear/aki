# CLAUDE.md
このファイルは、Claude CodeがAkiのソースコードを扱う際に知っておくべきことを提供するためのものです。

## 概要
AkiはFastAPIのようなルーティング機能をベースとしたPython向けのWebアプリケーションフレームワークです。

HTTPリクエスト/レスポンスの処理には[Kaede](https://github.com/nercone-aki/kaede/)を使用しています。
